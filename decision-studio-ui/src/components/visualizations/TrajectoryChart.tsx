    ...
    <div className="relative">
      ...
      >
        <g transform={`translate(${MARGIN.left},${MARGIN.top})`}>
          ...
          {/* Actual line — emerald solid with dots */}
          ...
          >
            ...
            {expectedVal !== null && (
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <span className="text-blue-400 font-mono ml-auto pl-3">{expectedVal.toFixed(2)}</span>
              </div>
            )}
            {actualVal !== null && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-emerald-400 font-mono ml-auto pl-3">{actualVal.toFixed(2)}</span>
              </div>
            )}
          </motion.div>
        );
      ...
      <div className="flex items-center gap-6 mt-3 pt-3 border-t border-slate-800">
        <div className="flex items-center gap-1.5">
          <svg width={20} height={8}>
            <line x1={0} y1={4} x2={20} y2={4} stroke="#ef4444" strokeWidth={1.5} strokeDasharray="4,3" />
          </svg>
          <span className="text-[10px] text-slate-400">Inaction</span>
        </div>
        <div className="flex items-center gap-1.5">
          <svg width={20} height={8}>
            <line x1={0} y1={4} x2={20} y2={4} stroke="#3b82f6" strokeWidth={1.5} strokeDasharray="4,3" />
          </svg>
