...
class Situation(BaseModel):
    ...
    key_observations: Optional[List[str]] = Field(None, description="2–3 plain-language observations generated by SA during detection — pattern, magnitude, context")
    trend_note: Optional[str] = Field(
        None,
        description="One-sentence LLM-generated note when the intra-period monthly trend contradicts the headline YoY direction. None when trend confirms headline or data insufficient."
    )
